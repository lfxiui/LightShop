    ...
    <script type="text/javascript">
        ...
        $(function(){
            $(function () {
                $('#table').bootstrapTable({
                    idField: 'styleId',
                    url: '${pageContext.servletContext.contextPath}/style/styleList?randID='+Math.random(),
                    columns: [{
                        field: 'styleId',
                        title: 'ID'
                    }, {
                    ...
                    onEditableSave: function (field, row, oldValue, $el) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '${pageContext.servletContext.contextPath}/style/updateStyle',
        ...
        window.actionEvents = {
            'click .remove': function (e, value, row, index) {
                ...
                $.ajax({
                    type: 'post',
                    url: '${pageContext.servletContext.contextPath}/style/deleteStyle',
                    data: JSON.stringify(style),
                    contentType: 'application/json',
                    success: function(data) {
                        if(data == "success"){
                            alert('删除成功');
                            $("#table").bootstrapTable('removeByUniqueId',row.styleId);
                        }else {
                            alert("删除失败");
                        }
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-heading">风格管理</div>
                <div class="panel-body">
                    <div id="toolbar" class="btn-group">
                        <button type="button" class="btn  btn-info" data-toggle="modal" data-target="#myModal">添加风格</button>
                    </div>
                    <table data-search="true"
                           ...
                           data-toolbar="#toolbar"  data-detail-formatter="detailFormatter" data-cache="false" id="table" data-unique-id="styleId">
                    </table>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="div1">
                <form class="form-horizontal" role="form" id="form" action="${pageContext.servletContext.contextPath}/style/addStyle" method="post">
                    <div class="form-group">
                        <label for="name">风格名称</label>
                        <input type="text" class="form-control" id="name" name="styleName" placeholder="请输入风格名称">
                    </div>
                </form>
            </div>
